if (ALPSCore_HAS_MPI)
    ...
    set(mpi_test_file ${scratch_directory}/cmake_mpi_test.cpp)
    file(WRITE ${mpi_test_file}
            "#include <mpi.h>\n"
            "int main(int argc, char **argv) {\n"
            "  MPI_Init(&argc, &argv);\n"
            "  MPI_Finalize();\n"
            "}\n")
    try_compile(compiler_has_mpi ${scratch_directory} ${mpi_test_file})

    if (compiler_has_mpi)
        set(ALPS_HAVE_MPI TRUE)
        message(STATUS "Your compiler supports MPI: "  ${CMAKE_CXX_COMPILER})
    else()
...
Depending on your platform this may lead to problems.")
    ...
    message(FATAL_ERROR "Error: ALPSCore must be built with MPI support!")
endif()
