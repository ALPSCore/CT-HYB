...
template<class SCALAR,class OBS> struct create_observable_helper {
...
template<class SCALAR,class OBS,class DATA> struct measure_observable_helper {
...
template<class SCALAR,int DIMENSION,class OBS> struct measure_multiarray_helper {
 ...
 * ****/
template<class OBS> struct create_observable_helper<double,OBS> {
  void static operate(observableset_t& meas, const char* obs_name) {
...
//measure a scalar
template<class OBS> struct measure_observable_helper<double ,OBS, double > {
...
//measure a vector
template<class OBS> struct measure_observable_helper<double, OBS, std::vector<double > > {
 ...
 * ****/
template<class OBS> struct create_observable_helper<std::complex<double> ,OBS> {
  void static operate(observableset_t& meas, const char* obs_name) {
    meas << OBS(std::string(obs_name)+"_Re");
    meas << OBS(std::string(obs_name)+"_Im");
  };
...
//measure a scalar
template<class OBS> struct measure_observable_helper<std::complex<double> ,OBS, std::complex<double> > {
...
//measure a vector
template<class OBS> struct measure_observable_helper<std::complex<double>, OBS, std::vector<std::complex<double> > > {
...
void
measure_simple_multiarray_observable(observableset_t& meas, const char* obs_name, const boost::multi_array<SCALAR,DIMENSION>& data) {
