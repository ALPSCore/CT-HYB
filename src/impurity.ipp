...
void HybridizationSimulation<IMP_MODEL>::define_parameters(parameters_type &parameters) {
  ...
  long > ("timelimit", "Total simulation time (in units of second)")
      ...
      .define<int>("measurement.G2.max_matrix_size", 50, "Max size of inverse matrix for measurement.")
      ...
      .define<double>("measurement.two_time_G2.Lambda", 1000.0, "Lambda parameter for the Bosonic IR basis")
